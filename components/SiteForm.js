  ...
  return (
    <form onSubmit={handleClick}>
        ...
        <div style={{width:'100%', padding: '0 2em', display:'flex'}}>
            <button disabled={disbledBtn} type='submit' className='btn' id='btn' style={{marginTop:'-0.2em', cursor:'pointer', marginRight:2}}>
            ...
            </button>
            {
                ...
                <></>
                :
                <button type='button' style={{width:60, borderRadius: 9, border:'none', backgroundColor: 'rgb(14 120 202)', color:'white'}}>
                    <Image src="/fingerprint.png" width={60} height={60} alt="sidikjari"/>
                </button>
            }
        </div>
    </form>
